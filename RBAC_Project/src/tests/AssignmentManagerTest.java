...
public class AssignmentManagerTest {
    ...
    void setUp() {
        ...
        testUser = User.create("testuser", "Test java.User", "test@mail.com");
        ...
        testRole = new Role("TEST_ROLE", "Test java.Role", perms);
    ...
    void testRevokeAssignment() {
        ...
        Assertions.assertFalse(permanentAssignment.isActive());
    }
    ...
    void testEquals() {
        ...
        Assertions.assertTrue(manager1.equals(manager2));
    }
